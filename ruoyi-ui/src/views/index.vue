  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          <el-link
            href="htt://www.aliyun1.zyp/minisite/goods?userCode=brki8iof"
            type="primary"
            target="_blank"
          >https://www.aliyun1.com/minisite/goods?userCode=brki8iof</el-link
          >
          <br/>
          <el-link
            ...
            type="primary"
            target="_blank"
          >https://cloud.tencent1.com/redirect.php?redirect=1025&cps_key=198c8df2ed259157187173bc7f4f32fd&from=console</el-link
          >
          <br />
          阿里云服务器折扣区啊
          <el-link href="http://aly.yaopeng.com" type="primary" target="_blank"
          >>☛☛点我进入☚☚</el-link
          >
          &nbsp;&nbsp;&nbsp; 腾讯云服务器秒杀区
          <el-link href="https://gitee.com/zhao-yaopeng" type="primary" target="_blank"
          >>☛☛点我进入☚☚</el-link
          ><br />
          <h4 class="text-danger">
           可1111叠加官网常规优惠使用。(仅限新用户)
          </h4>
        </blockquote>
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>后台管理系统</h2>
        <p>
          一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。她可以用于所有的Web应用程序，如网站管理后台，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://gitee.com/zhao-yaopeng/projects')"
          >访问码云gitee</el-button
          >
          <el-button
            icon="HomeFilled"
            plain
            @click="goTarget('https://gitee.com/zhao-yaopeng')"
          >访问夕阳主页</el-button
          >
        </p>
      </el-col>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            ...
            <!--&lt;!&ndash;              <ol>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>定时任务违规的字符</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>重置时取消部门选中</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增返回警告消息提示</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>忽略不必要的属性数据返回</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修改参数键名时移除前缓存配置</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>导入更新用户数据前校验数据权限</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>兼容Excel下拉框内容过多无法显示的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级echarts到最新版本5.4.0</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级core-js到最新版本3.25.3</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级oshi到最新版本6.4.0</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级kaptcha到最新版2.3.3</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级druid到最新版本1.2.15</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级fastjson到最新版2.0.20</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级pagehelper到最新版1.4.6</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化弹窗内容过多展示不全问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化swagger-ui静态资源使用缓存</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>开启TopNav没有子菜单隐藏侧边栏</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>删除fuse无效选项maxPatternLength</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化导出对象的子列表为空会出现[]问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化编辑头像时透明部分会变成黑色问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化小屏幕上修改头像界面布局错位的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复代码生成勾选属性无效问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复文件上传组件格式验证问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复回显数据字典数组异常问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复sheet超出最大行数异常问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复Log注解GET请求记录不到参数问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复调度日志点击多次数据不变化的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复主题颜色在Drawer组件不会加载问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复文件名包含特殊字符的文件无法下载问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复table中更多按钮切换主题色未生效修复问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复某些特性的环境生成代码变乱码TXT文件问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复代码生成图片/文件/单选时选择必填无法校验问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复某些特性的情况用户编辑对话框中角色和部门无法修改问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>其他细节优化</li>&ndash;&gt;-->
            <!--&lt;!&ndash;              </ol>&ndash;&gt;-->
            <!--            </el-collapse-item>-->
            <!--            <el-collapse-item title="v3.8.4 - 2022-09-26">-->
            <!--&lt;!&ndash;              <ol>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>数据逻辑删除不进行唯一验证</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>Excel注解支持导出对象的子列表方法</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>Excel注解支持自定义隐藏属性列</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>Excel注解支持backgroundColor属性设置背景色</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>支持配置密码最大错误次数/锁定时间</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>登录日志新增解锁账户功能</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>通用下载方法新增config配置选项</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>支持多权限字符匹配角色数据权限</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>页面内嵌iframe切换tab不刷新数据</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>操作日志记录支持排除敏感属性字段</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复多文件上传报错出现的异常问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复图片预览组件src属性为null值控制台报错问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级oshi到最新版本6.2.2</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级fastjson到最新版2.0.14</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级pagehelper到最新版1.4.3</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级core-js到最新版本3.25.2</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级element-ui到最新版本2.15.10</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化任务过期不执行调度</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化字典数据使用store存取</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化修改资料头像被覆盖的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化修改用户登录账号重复验证</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化代码生成同步后值NULL问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化定时任务支持执行父类方法</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化用户个人信息接口防止修改部门</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化布局设置使用el-drawer抽屉显示</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化没有权限的用户编辑部门缺少数据</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化日志注解记录限制请求地址的长度</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化excel/scale属性导出单元格数值类型</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化日志操作中重置按钮时重复查询的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化多个相同角色数据导致权限SQL重复问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化表格上右侧工具条（搜索按钮显隐&右侧样式凸出）</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>其他细节优化</li>&ndash;&gt;-->
            <!--&lt;!&ndash;              </ol>&ndash;&gt;-->
            <!--            </el-collapse-item>-->
            <!--            <el-collapse-item title="v1.0.0 - 2022-06-27">-->
            <!--&lt;!&ndash;              <ol>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增缓存列表菜单功能</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>代码生成树表新增(展开/折叠)</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>Excel注解支持color字体颜色</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增Anonymous匿名访问不鉴权注解</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>用户头像上传限制只能为图片格式</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>接口使用泛型使其看到响应属性字段</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>检查定时任务bean所在包名是否为白名单配置</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>添加页签openPage支持传递参数</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>用户缓存信息添加部门ancestors祖级列表</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级element-ui到最新版本2.15.8</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级oshi到最新版本6.1.6</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级druid到最新版本1.2.11</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级fastjson到最新版2.0.8</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级spring-boot到最新版本2.5.14</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>降级jsencrypt版本兼容IE浏览器</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>删除多余的salt字段</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增获取不带后缀文件名称方法</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增获取配置文件中的属性值方法</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增内容编码/解码方便插件集成使用</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>字典类型必须以字母开头，且只能为（小写字母，数字，下滑线）</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化设置分页参数默认值</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化对空字符串参数处理的过滤</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化显示顺序orderNum类型为整型</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化表单构建按钮不显示正则校验</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化字典数据回显样式下拉框显示值</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化R响应成功状态码与全局保持一致</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化druid开启wall过滤器出现的异常问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化用户管理左侧树型组件增加选中高亮保持</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化新增用户与角色信息&用户与岗位信息逻辑</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化默认不启用压缩文件缓存防止node_modules过大</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复字典数据显示不全问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复操作日志查询类型条件为0时会查到所有数据</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复Excel注解prompt/combo同时使用不生效问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>其他细节优化</li>&ndash;&gt;-->
            <!--&lt;!&ndash;              </ol>&ndash;&gt;-->
            <!--            </el-collapse-item>-->
            ...
            <!--&lt;!&ndash;              <ol>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增Vue3前端代码生成模板</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增图片预览组件</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>新增压缩插件实现打包Gzip</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>自定义xss校验注解实现</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>自定义文字复制剪贴指令</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>代码生成预览支持复制内容</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>路由支持单独配置菜单或角色权限</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>用户管理部门查询选择节点后分页参数初始</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复用户分配角色属性错误</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复打包后字体图标偶现的乱码问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复菜单管理重置表单出现的错误</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复版本差异导致的懒加载报错问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复Cron组件中周回显问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复定时任务多参数逗号分隔的问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复根据ID查询列表可能出现的主键溢出问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>修复tomcat配置参数已过期问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级clipboard到最新版本2.0.8</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级oshi到最新版本v5.8.6</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级fastjson到最新版1.2.79</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级spring-boot到最新版本2.5.8</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>升级log4j2到2.17.1，防止漏洞风险</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化下载解析blob异常提示</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化代码生成字典组重复问题</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化查询用户的角色组&岗位组代码</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化定时任务cron表达式小时设置24</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化用户导入提示溢出则显示滚动条</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化防重复提交标识组合为(key+url+header)</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>优化分页方法设置成通用方便灵活调用</li>&ndash;&gt;-->
            <!--&lt;!&ndash;                <li>其他细节优化</li>&ndash;&gt;-->
            <!--&lt;!&ndash;              </ol>&ndash;&gt;-->
            <!--            </el-collapse-item>-->
            ...
            <!--              </ol>-->
            <!--            </el-collapse-item>-->
            <el-collapse-item title="v1.1.0 - 2022-04-22">
              <ol>
                <li>新增在线用户管理</li>
            ...
            <el-collapse-item title="v1.0.0 - 2022-04-20">
              <ol>
                <li>前后端分离系统1.0.0版本</li>
              </ol>
            </el-collapse-item>
          </el-collapse>
        </el-card>
